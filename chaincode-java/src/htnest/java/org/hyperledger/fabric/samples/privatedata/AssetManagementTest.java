...
// import static org.hyperledger.fabric.samples.privatedata.AssetManagement.AGREEMENT_KEYPREFIX;
import static org.hyperledger.fabric.samples.privatedata.AssetManagement.ASSET_COLLECTION_NAME;
...
public final class AssetManagementTest {
    ...
    class InvokeWriteTransaction {
        ...
        public void createAssetWhenAssetExists() {
            AssetManagement contract = new AssetManagement();
    ...
    class QueryReadAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            assertThat(testAsset1).isEqualTo(testAsset1);
        }
        ...
        public void whenAssetDoesNotExist() {
            ...
            String asset = contract.ReadAsset(ctx, testAsset1ID);
    ...
    private static ArrayList<String> acl = new ArrayList<String>() {{
        add("org1id");
        add("org2id");
    }};
    private static Asset testAsset1 = new Asset("testasset", "asset1", "blue", 5, testOrg1Client, "abc123", acl);
    private static byte[] dataAsset1Bytes = "{ \"objectType\": \"testasset\", \"assetID\": \"asset1\", \"color\": \"blue\", \"size\": 5, \"owner\": \"testOrg1User\", \"appraisedValue\": 300, \"filekey\":\"abc123\",\"acl\":[\"org1id\",\"org2id\",\"org3id\"]}".getBytes();
